...
This feature is **transparent** to non-exotic legacy C code (not redefining `default` with a macro), as declaring a variable named `default` has been invalid in C.
