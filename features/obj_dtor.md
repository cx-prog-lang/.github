...
## Caveat
 ...
 - The cleanup function is a convention, except that the undefined form is a no-op; it is **not** called automatically in any way (e.g., at the end of the object's storage duration).
