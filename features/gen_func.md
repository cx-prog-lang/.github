...
Generic functions can be _explicitly instantiated_ ("_specialized_") by manually declaring or defining generic functions with actual types. In this case, they can reuse the body of the generic definitions by specifying `...` for their bodies. The explicitly instantiated generic functions are inserted on the spot.
